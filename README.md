# Mon Portfolio de Développeuse Fullstack

Bienvenue sur le dépôt de mon portfolio personnel ! Ce site présente mon parcours, mes compétences techniques et mes projets réalisés durant ma formation.

## À propos de moi

Je suis **Charlotte**, développeuse web Fullstack actuellement en recherche d'une **alternance**. Passionnée par la résolution de problèmes et la création d'interfaces intuitives, j'aime transformer des idées complexes en solutions numériques élégantes.
...
Le site est déployé automatiquement via **Render**. Les fichiers `robots.txt` et `sitemap.xml` sont optimisés pour le SEO et l'indexation Google.

---

## ⚖️ Crédits & Propriété Intellectuelle
...
_Fait avec passion par Charlotte — 2026_
