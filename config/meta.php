...
return [
    ...
    "about_me" => [
        "title" => "À propos de moi - Charlotte - Passionnée par le Dévelloppement",
        "description" => "Découvrez mon parcours, mes technologies de prédilection (PHP, JS, SQL) et ma motivation pour rejoindre votre équipe en alternance.",
        "robots" => "index, follow",
        "ogtitle" => "Faisons connaissance - Charlotte Dévellopeuse Full Stack",
        "ogdescription" => "Mon parcours, mes technos de prédilection et pourquoi le code est devenu une passion. Venez découvrir mon profil !",
        "image" => "aboutme.png"
    ],
    "contact" => [
        "title" => "Contactez-moi - Charlotte - Une opportunité d'alternance ?",
        "description" => "Besoin d'une développeuse motivée ? Envoyez-moi un message via ce formulaire pour discuter de vos projets ou d'une alternance.",
        "robots" => "noindex, follow",
        "ogtitle" => "Travaillons ensemble ! - Contact - Charlotte, Développeuse Web",
        "ogdescription" => "Un projet, une question ou une offre d'alternance ? Contactez-moi directement via ce formulaire.",
        "image" => ""
    ],
    ...
    // Page techniques
    "legal" => [
        "title" => "Mentions Légales - Charlotte Portfolio",
        "description" => "Informations légales et protection des données personnelles (RGPD) concernant ce site portfolio.",
        "robots" => "noindex, follow",
        "ogtitle" => "",
        "ogdescription" => "",
        "image" => ""
    ...
    "error" => [
        "title" => "Page introuvable (404) - Charlotte",
