  ...
  <section class="overflow-hidden sm:grid sm:grid-cols-2 sm:items-center">
    <div class="p-8 md:p-10 lg:px-15 lg:py-19">
      <div class="mx-auto max-w-lg text-center ltr:sm:text-left rtl:sm:text-right">
        ...
        <h2 class="text-base pt-3 md:text-xl">
          Développeuse Full Stack en apprentissage, capable de corriger des bugs avec le sourire
          ...
          <a href="mailto:charlotte.michalletferrier@gmail.com"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="-0.5 -0.5 16 16" fill="none" stroke="#ececec"
              ...
              <path
                ...
                stroke-width="1"></path>
              <path d="m13.75 3.75 -6.25 4.375L1.25 3.75" stroke-width="1"></path>
            </svg>
            <p>Mail</p>
          </a>
        </div>
  ...
  <section>
    <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <div class="mx-auto max-w-lg text-center">
        <h2 class="text-3xl/tight font-bold sm:text-4xl">Mes compétences</h2>
      </div>
      ...
      <div class="mt-8 grid grid-cols-1 gap-8 md:grid-cols-3">
        <div class="rounded-lg border border-gray-200 px-6 py-4">
          <div class="inline-flex rounded-lg p-3">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 2048 2048">
              <path fill="#ECECEC"
                d="M1280 128h768v1920H0V37l1280 1280V128zM128 1920h1573L128 347v1573zm1627-128l128 128h37V256h-512v128h256v128h-256v128h256v128h-256v128h384v128h-384v128h256v128h-256v128h256v128h-165l128 128h165v128h-37zM384 1061l603 603H384v-603zm128 310v165h165l-165-165z" />
            </svg>
          </div>

          <h3 class="mt-1 pb-4 text-lg font-semibold">Conception & architecture</h3>
        ...
        <div class="rounded-lg border border-gray-200 px-6 py-4">
          ...
          <h3 class="mt-1 pb-4 text-lg font-semibold">Développement Front-end</h3>
          <div class="flex flex-wrap gap-1.5 mb-2">
            <span
              class="group inline-block rounded-full bg-linear-to-r from-[#00715E] via-[#008670] to-[#00DCBC] p-0.5 hover:text-white">
              <span class="block rounded-full bg-[#1A1D22] px-4 py-3 text-sm group-hover:bg-transparent">
        ...
        <div class="rounded-lg border border-gray-200 px-6 py-4">
          ...
          <h3 class="mt-1 pb-4 text-lg font-semibold">Développement back-end</h3>
          <div class="flex flex-wrap gap-1.5 mb-2">
            <span
              class="group inline-block rounded-full bg-linear-to-r from-[#00715E] via-[#008670] to-[#00DCBC] p-0.5 hover:text-white">
              <span class="block rounded-full bg-[#1A1D22] px-4 py-3 text-sm group-hover:bg-transparent">
            ...
            <span
              class="group inline-block rounded-full bg-linear-to-r from-[#00715E] via-[#008670] to-[#00DCBC] p-0.5 hover:text-white">
              <span class="block rounded-full bg-[#1A1D22] px-4 py-3 text-sm group-hover:bg-transparent">
                Sensible faille web (csrf, injection SQL...)
              </span>
            </span>
          </div>
        </div>
        ...
        <div class="rounded-lg border border-gray-200 p-6">
          ...
          <h3 class="mt-1 pb-4 text-lg font-semibold">Outils & worckflow</h3>
          <div class="flex flex-wrap gap-1.5 mb-2">
            <span
              class="group inline-block rounded-full bg-linear-to-r from-[#00715E] via-[#008670] to-[#00DCBC] p-0.5 hover:text-white">
              <span class="block rounded-full bg-[#1A1D22] px-4 py-3 text-sm group-hover:bg-transparent">
        ...
        <div class="rounded-lg border border-gray-200 p-6">
          ...
          <h3 class="mt-1 pb-4 text-lg font-semibold">En apprentissage Bachelor</h3>
          <div class="flex flex-wrap gap-1.5 mb-2">
            <span
              class="group inline-block rounded-full bg-linear-to-r from-[#00715E] via-[#008670] to-[#00DCBC] p-0.5 hover:text-white">
              <span class="block rounded-full bg-[#1A1D22] px-4 py-3 text-sm group-hover:bg-transparent">
        ...
        <div class="rounded-lg border border-gray-200 p-6">
          ...
          <h3 class="mt-1 pb-4 text-lg font-semibold">Compétences transférables</h3>
          <div class="flex flex-wrap gap-1.5 mb-2">
            <span
              class="group inline-block rounded-full bg-linear-to-r from-[#00715E] via-[#008670] to-[#00DCBC] p-0.5 hover:text-white">
              <span class="block rounded-full bg-[#1A1D22] px-4 py-3 text-sm group-hover:bg-transparent">
